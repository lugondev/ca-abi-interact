...
import { TContract, TAbiItem } from "@entities/contract";

type TProps = {
  contract: TContract;
  onAbiChange: (abi: TContract["abi"]) => void;
};
...
export const ManageAbiFunctionsLocal = ({ contract, onAbiChange }: TProps) => {
